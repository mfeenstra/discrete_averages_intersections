# Identifies intersection for 2 separate discrete timeseries data.  More difficult than continuous functions.
class IchimokuCrossingsService
  ...
  def initialize(symbol)
    ...
    average_data.each_with_index do |ichi, i|
      ...
      # visualize as a 3-day sliding window with subtraction of consecutive timeseries values
